...
VARIANTS = {
    ...
    "ifs": ("mesh.ifs_add", [
        ...
        ("TWINA", "Twindragon A",
         dict(mode='RADIX', preset='TWIN_A')),
        ("TWIND", "Twindragon D",
         dict(mode='RADIX', preset='TWIN_D')),
        ("TWING", "Twindragon G",
         dict(mode='RADIX', preset='TWIN_G')),
        ...
        ("SIERPTETRA", "Sierpinski tetrahedron",
         dict(mode='IFS', dimension='3',
              ifs_preset='SIERP_TETRA', output='SOLIDS')),
        ("MENGER", "Menger sponge",
         dict(mode='IFS', dimension='3',
              ifs_preset='MENGER', output='SOLIDS',
              seed_solid='CUBE', depth=3)),
        ("VOXEL", "Sierpinski octahedron (voxels)",
         dict(mode='IFS', dimension='3',
              ifs_preset='SIERP_OCTA', output='VOXEL')),
        ("ISO", "Sierpinski tetrahedron (smooth)",
         dict(mode='IFS', dimension='3',
              ifs_preset='SIERP_TETRA', output='ISO')),
        ("BMMSIERP", "Sierpinski triangle in 3D (Bandt et al.)",
         dict(mode='IFS', dimension='3',
              ifs_preset='BMM_SIERP', output='ISO')),
        ("BMMSIERPREV", "...and its reverse fractal",
         dict(mode='IFS', dimension='3',
              ifs_preset='BMM_SIERP', output='ISO', reverse=True)),
        ("BMMTETRA", "Modified fractal tetrahedron (Bandt et al.)",
         dict(mode='IFS', dimension='3',
              ifs_preset='BMM_TETRA', output='ISO')),
        ("BMMCUBE", "Modified cube (Bandt et al.)",
         dict(mode='IFS', dimension='3',
              ifs_preset='BMM_CUBE', output='ISO')),
        ("FERN", "Barnsley fern (2-D)",
         dict(mode='IFS', dimension='2',
              ifs_preset='FERN2D', output='RELIEF')),
        ("SIERPTRI", "Sierpinski triangle (2-D)",
         dict(mode='IFS', dimension='2',
              ifs_preset='SIERP_TRI', output='RELIEF')),
        ("DRAGON", "Heighway dragon (2-D)",
         dict(mode='IFS', dimension='2',
              ifs_preset='DRAGON', output='RELIEF')),
        ("LEVY", "Levy C curve (2-D)",
         dict(mode='IFS', dimension='2',
              ifs_preset='LEVY', output='RELIEF')),
        ("KOCH", "Koch curve (2-D)",
         dict(mode='IFS', dimension='2',
              ifs_preset='KOCH', output='RELIEF')),
    ]),
