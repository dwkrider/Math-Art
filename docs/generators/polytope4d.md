...
| Style | Struts | Struts (tubes along the projected edges, no vertex spheres), Ball and Stick (struts plus a sphere at every vertex), Wireframe (bare edge polylines), or Leonardo (da Vinci) (a flat open panel per 2D face). |
