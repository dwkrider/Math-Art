...
FACTS = {
    ...
    # Schoen's starfish surfaces that Brakke pictures but publishes
    # NO datafile for.  Eight of the sixteen have a `.fe` and ship;
    # these eight do not exist in the mirror or in starfish.tar, so
    # there is nothing to build them from and nothing to verify
    # against.  Recorded because the surfaces are real and named, in
    # the same spirit as an algebraic record whose polynomial is null:
    # the record states that we do not build it, and why.
    "starfish-2-4-genus-79": {
        "name": "Starfish 2-4 Surface (genus 79)",
        "discovered_by": "Alan H. Schoen",
        "primary_family": "minimal-periodic",
        "tradition": ["crystallographic"],
        "curvature": {"condition": "minimal"},
        "topology": {"orientable": True, "compact": False,
                     "complete": True, "genus": 79},
        "symmetry": {"kind": "crystallographic",
                     "periodicity_rank": 3},
        "embedding": {"quality": "embedded"},
    },
    "starfish-3-4-genus-91": {
        "name": "Starfish 3-4 Surface (genus 91)",
        "discovered_by": "Alan H. Schoen",
        "primary_family": "minimal-periodic",
        "tradition": ["crystallographic"],
        "curvature": {"condition": "minimal"},
        "topology": {"orientable": True, "compact": False,
                     "complete": True, "genus": 91},
        "symmetry": {"kind": "crystallographic",
                     "periodicity_rank": 3},
        "embedding": {"quality": "embedded"},
    },
    "starfish-4-2-genus-71": {
        "name": "Starfish 4-2 Surface (genus 71)",
        "discovered_by": "Alan H. Schoen",
        "primary_family": "minimal-periodic",
        "tradition": ["crystallographic"],
        "curvature": {"condition": "minimal"},
        "topology": {"orientable": True, "compact": False,
                     "complete": True, "genus": 71},
        "symmetry": {"kind": "crystallographic",
                     "periodicity_rank": 3},
        "embedding": {"quality": "embedded"},
    },
    "starfish-4-4-genus-103": {
        "name": "Starfish 4-4 Surface (genus 103)",
        "discovered_by": "Alan H. Schoen",
        "primary_family": "minimal-periodic",
        "tradition": ["crystallographic"],
        "curvature": {"condition": "minimal"},
        "topology": {"orientable": True, "compact": False,
                     "complete": True, "genus": 103},
        "symmetry": {"kind": "crystallographic",
                     "periodicity_rank": 3},
        "embedding": {"quality": "embedded"},
    },
    "starfish-5-1-genus-67": {
        "name": "Starfish 5-1 Surface (genus 67)",
        "discovered_by": "Alan H. Schoen",
        "primary_family": "minimal-periodic",
        "tradition": ["crystallographic"],
        "curvature": {"condition": "minimal"},
        "topology": {"orientable": True, "compact": False,
                     "complete": True, "genus": 67},
        "symmetry": {"kind": "crystallographic",
                     "periodicity_rank": 3},
        "embedding": {"quality": "embedded"},
    },
    "starfish-5-2-genus-83": {
        "name": "Starfish 5-2 Surface (genus 83)",
        "discovered_by": "Alan H. Schoen",
        "primary_family": "minimal-periodic",
        "tradition": ["crystallographic"],
        "curvature": {"condition": "minimal"},
        "topology": {"orientable": True, "compact": False,
                     "complete": True, "genus": 83},
        "symmetry": {"kind": "crystallographic",
                     "periodicity_rank": 3},
        "embedding": {"quality": "embedded"},
    },
    "starfish-5-3-genus-99": {
        "name": "Starfish 5-3 Surface (genus 99)",
        "discovered_by": "Alan H. Schoen",
        "primary_family": "minimal-periodic",
        "tradition": ["crystallographic"],
        "curvature": {"condition": "minimal"},
        "topology": {"orientable": True, "compact": False,
                     "complete": True, "genus": 99},
        "symmetry": {"kind": "crystallographic",
                     "periodicity_rank": 3},
        "embedding": {"quality": "embedded"},
    },
    "starfish-5-4-genus-115": {
        "name": "Starfish 5-4 Surface (genus 115)",
        "discovered_by": "Alan H. Schoen",
        "primary_family": "minimal-periodic",
        "tradition": ["crystallographic"],
        "curvature": {"condition": "minimal"},
        "topology": {"orientable": True, "compact": False,
                     "complete": True, "genus": 115},
        "symmetry": {"kind": "crystallographic",
                     "periodicity_rank": 3},
        "embedding": {"quality": "embedded"},
    },
