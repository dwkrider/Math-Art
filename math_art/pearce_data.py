...
#: rows of Table 8.1 with no verified geometry yet.  They are
#: NOT offered by the operator.  See the module header.
UNRESOLVED = (
    (2, 'Universal trihedron (enantiomorphic)'),
    (3, 'Trirectangular trihedron'),
    (4, 'Digonal trihedron (enantiomorphic)'),
    (5, 'Trigonal trihedron'),
    (7, 'Delta trihedron'),
    (8, 'bcc trihedron'),
    (9, 'Rectangular trihedron (enantiomorphic)'),
    (10, 'Double rectangular trihedron'),
    (13, 'fcc tetragonal tetrahedron'),
    (15, 'Universal tetrahedron'),
    (16, 'Digonal tetrahedron'),
    (17, 'Truncated orthorhombic tetrahedron'),
    (18, 'Digonal hemisaddle tetrahedron'),
    (19, 'Wurtzite nodal tetrahedron'),
    (20, 'bcc orthorhombic tetrahedron'),
    (21, 'Rectangular orthorhombic tetrahedron'),
    (22, 'Hemisaddle digonal disphenoid'),
    (23, 'Double delta tetrahedron'),
    (24, 'Trigonal pentahedron'),
    (25, 'Wurtzite pentahedron'),
    (26, 'Digonal pentahedron'),
    (27, 'Triangular hexahedron'),
    (28, 'Cubical saddle hexahedron'),
    (29, 'Saddle cube'),
    (30, 'Truncated tetragonal tetrahedron'),
    (31, 'Universal hexahedron'),
    (32, 'Augmented universal hexahedron'),
    (33, 'Bioctagonal hexahedron'),
    (34, 'Bidodecagonal hexahedron'),
    (35, 'Tetragonal saddle hexahedron'),
    (36, 'Fissioned tetragonal saddle hexahedron'),
    (37, 'Tetragonal octagonal hexahedron'),
    (38, 'Trigonal hexahedron'),
    (39, 'Trapezoidal trigonal hexahedron'),
    (40, 'bcc octahedron'),
    (41, 'fcc saddle octahedron'),
    (42, 'Tetragonal pentagonal octahedron'),
    (43, 'Tetrahedral decahedron'),
    (44, 'Saddle dodecahedron'),
    (45, 'Blunted saddle dodecahedron'),
    (46, 'Truncated tetrahedral decahedron'),
    (47, 'bcc saddle cuboctahedron'),
    (48, 'Fissioned bcc saddle cuboctahedron'),
    (49, 'fcc saddle cuboctahedron'),
    (50, 'Truncated fcc saddle cuboctahedron'),
    (51, 'Saddle cube dodecahedron'),
    (52, 'Truncated saddle dodecahedron'),
    (53, 'Universal cuboctadodecahedron'),
)
