...
_EDDY_OUTER = (
    (-0.618034, +0.000000), (-0.919959, +0.187349), (-0.939003, +0.196352),
    (-0.971982, +0.202871), (-0.996855, +0.210665), (-1.015938, +0.219601),
    (-1.035975, +0.232688), (-1.056686, +0.252617), (-1.075813, +0.283111),
    (-1.088822, +0.316195), (-1.097034, +0.353953), (-1.100326, +0.393122),
    (-1.099354, +0.435811), (-1.094110, +0.481995), (-1.084397, +0.534645),
    (-1.070211, +0.592414), (-1.052937, +0.648927), (-1.034226, +0.699253),
    (-1.012491, +0.747650), (-0.989674, +0.790531), (-0.964855, +0.830576),
    (-0.937635, +0.868604), (-0.907426, +0.905282), (-0.874086, +0.940495),
    (-0.837538, +0.974073), (-0.804370, +1.000149), (-0.767701, +1.024686),
    (-0.717719, +1.052386), (-0.666195, +1.074829), (-0.644897, +1.082324),
    (-0.561451, +1.102587), (-0.490091, +1.109334), (-0.435392, +1.107649),
    (-0.375021, +1.098995), (-0.318072, +1.082991), (-0.284308, +1.069372),
    (-0.251300, +1.052751), (-0.189079, +1.011103), (-0.132022, +0.958515),
    (-0.106554, +0.928900), (-0.084309, +0.898446), (-0.049078, +0.835294),
    (-0.023599, +0.768922), (-0.014925, +0.731728), (-0.010658, +0.695399),
    (-0.010245, +0.651401), (-0.014417, +0.619180), (+0.000838, +0.606133),
    (+0.183517, +0.492837), (+0.381966, +0.618034), (+0.354336, +0.666386),
    (+0.300613, +0.750462), (+0.225418, +0.847830), (+0.174613, +0.903280),
    (+0.128724, +0.947885), (+0.078216, +0.991606), (+0.030997, +1.026675),
    (-0.023549, +1.062419), (-0.077876, +1.093157), (-0.131943, +1.118859),
    (-0.187242, +1.140301), (-0.246189, +1.158232), (-0.307986, +1.172296),
    (-0.357377, +1.180605), (-0.434698, +1.187894), (-0.441754, +1.198662),
    (-0.445336, +1.234638), (-0.442896, +1.267312), (-0.434675, +1.308100),
    (-0.508349, +1.306135), (-0.505802, +1.271380), (-0.507142, +1.244978),
    (-0.512666, +1.216317), (-0.522803, +1.190200), (-0.602148, +1.171351),
    (-0.665140, +1.151204), (-0.724771, +1.127451), (-0.786439, +1.097212),
    (-0.853168, +1.057676), (-0.901336, +1.025272), (-0.971469, +0.966953),
    (-1.028121, +0.910626), (-1.096208, +0.826225), (-1.159629, +0.724726),
    (-1.183660, +0.677539), (-1.219098, +0.595670), (-1.246739, +0.520038),
    (-1.264549, +0.452184), (-1.277766, +0.378478), (-1.284575, +0.303441),
    (-1.278881, +0.199196), (-1.262112, +0.128035), (-1.238616, +0.066064),
    (-1.221451, +0.033107), (-1.201626, +0.001955), (-1.178587, -0.028202),
    (-1.151105, -0.058879), (-1.096658, -0.107591), (-1.028798, -0.152503),
    (-0.983137, -0.176544), (-0.934683, -0.197805),
)

_EDDY_HOLE_A = (
    (-0.896549, -0.049678), (-0.937636, -0.073630), (-0.988389, -0.049889),
    (-1.033166, -0.023578), (-1.073590, +0.006577), (-1.108593, +0.039781),
    (-1.136297, +0.074307), (-1.153880, +0.103645), (-1.169044, +0.136565),
    (-1.180899, +0.171510), (-1.188664, +0.205809), (-1.193781, +0.247776),
    (-1.195515, +0.294070), (-1.193501, +0.341874), (-1.188407, +0.378712),
    (-1.171487, +0.275792), (-1.163193, +0.249622), (-1.144165, +0.211291),
    (-1.121167, +0.174806), (-1.109002, +0.159640), (-1.076826, +0.133388),
    (-1.038171, +0.111808), (-1.004317, +0.098022), (-0.965698, +0.092859),
    (-0.946241, +0.087327), (-0.813078, +0.000335),
)

_EDDY_HOLE_B = (
    (+0.173139, +0.618222), (+0.084434, +0.672345), (+0.081688, +0.706561),
    (+0.074376, +0.747279), (+0.064509, +0.785457), (+0.052002, +0.820465),
    (+0.025029, +0.875188), (-0.031901, +0.965330), (+0.040250, +0.912393),
    (+0.081322, +0.875128), (+0.118600, +0.836647), (+0.178469, +0.761840),
    (+0.244087, +0.660069),
)
...
def eddy_motif(d=1.0):
    ...
    Placement is exact, and it is a pretty one.  Scale the traced
    outline by phi, leave it unrotated, and translate it by
    (-1/phi, +1/phi): the two tips then land on the 5-part meeting
    point at (-1/phi, 0) and on the shell-1 crossing at
    (1/phi^2, 1/phi), both to 2e-08.  Every mating edge comes out at
    dihedral 144 -- a bevel of exactly 18.00 degrees, which is what
    Hart says he set on the belt sander.

    The tips sit on the OUTSIDE of the ball, so a tip fills the
    exterior angle at its joint rather than the interior one Frabjous,
    Krull and Solar Flair use; anchoring on the inner corners instead
    is what made the earlier fits wander.
                ...
                if pv2:
                    ...
                    if bevels:
                        ...
                        for bi, (th, _bx, _by, _el) in enumerate(bevels):
                            ...
                            # Both conventions, because they differ by
                            # the complement and picking the wrong one
                            # is a ruined part.  th/2 is the angle
                            # between the cut face and the face of the
                            # stock; 90 - th/2 is the tilt off square,
                            # which is what a saw table or a sander
                            # jig is actually set to.  Hart quotes
                            # Eddy's joints as "18 degrees" and they
                            # are 144-degree dihedrals: 72 off the
                            # face, 18 off square.
                            tc.body = ("%s  %.2f° cut, %.2f° off square"
                                       % (tag, th / 2.0, 90.0 - th / 2.0)
                                       + chr(10)
                                       + "%.2f° dihedral" % th)
                            tc.size = tsize
                            tc.align_x = 'CENTER'
