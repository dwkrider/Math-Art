...
OPS = [
    ...
    ("notable polyhedron reflexive mirror pair",
     lambda: bpy.ops.mesh.notable_polyhedron_add(
         solid='CY_MIRROR_CUBE')),
    ("notable polyhedron k3 polytope",
     lambda: bpy.ops.mesh.notable_polyhedron_add(
         solid='CY_K3_POLYTOPE')),
    ("miscellaneous surface tropical calabi-yau",
     lambda: bpy.ops.mesh.curiosity_surface_add(surface='TROPICAL_CY')),
