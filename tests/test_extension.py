...
OPS = [
    ...
    # The Calabi-Yau family.  Each one is a different honest shadow
    # of a six-dimensional manifold, so each mode gets exercised.
    ("calabi-yau quintic cross-section",
     lambda: bpy.ops.mesh.calabi_yau_add(theta_steps=9, xi_steps=9)),
    ("calabi-yau brieskorn trefoil",
     lambda: bpy.ops.mesh.calabi_yau_add(family='BRIESKORN', power_p=2,
                                         power_q=3, theta_steps=9,
                                         xi_steps=9,
                                         boundary_curve=True)),
    ("calabi-yau fourth-dimension coloring",
     lambda: bpy.ops.mesh.calabi_yau_add(theta_steps=7, xi_steps=7,
                                         color='FOURTH', phase=0.3)),
    ("toric calabi-yau mirror pair",
     lambda: bpy.ops.mesh.toric_calabi_yau_add(mode='MIRROR',
                                               polytope='QUARTIC')),
    ("toric calabi-yau cube/octahedron mirror",
     lambda: bpy.ops.mesh.toric_calabi_yau_add(mode='MIRROR',
                                               polytope='CUBE',
                                               separation=0.0)),
    ("toric calabi-yau k3 polytope",
     lambda: bpy.ops.mesh.toric_calabi_yau_add(mode='K3POLYTOPE')),
    ("toric calabi-yau tropical surface",
     lambda: bpy.ops.mesh.toric_calabi_yau_add(mode='TROPICAL')),
    ("miscellaneous surface eguchi-hanson",
     lambda: bpy.ops.mesh.curiosity_surface_add(surface='EGUCHI_HANSON',
                                                resolution=24)),
    ("miscellaneous surface conifold deformed",
     lambda: bpy.ops.mesh.curiosity_surface_add(surface='CONIFOLD',
                                                conifold_delta=-0.25,
                                                resolution=24)),
    ("miscellaneous surface conifold node",
     lambda: bpy.ops.mesh.curiosity_surface_add(surface='CONIFOLD',
                                                conifold_delta=0.0,
                                                resolution=24)),
    ("miscellaneous surface conifold two sheets",
     lambda: bpy.ops.mesh.curiosity_surface_add(surface='CONIFOLD',
                                                conifold_delta=0.3,
                                                resolution=24)),
    ("calabi-yau syz discriminant graph",
     lambda: bpy.ops.mesh.calabi_yau_scaffold_add(mode='SYZ',
                                                  node_radius=0.03)),
    ("calabi-yau syz stereographic",
     lambda: bpy.ops.mesh.calabi_yau_scaffold_add(mode='SYZ',
                                                  projection='SPHERE')),
    ("calabi-yau fermat surface k3",
     lambda: bpy.ops.mesh.calabi_yau_scaffold_add(mode='FERMAT_CP3',
                                                  degree=4)),
    ...
    ("interlocking cubes",
     lambda: bpy.ops.mesh.interlocking_add(family='MCSCUBE', nx=4, ny=4)),
    ("interlocking octahedra",
    ...
    ("interlocking sl frame",
     lambda: bpy.ops.mesh.interlocking_add(family='SL', sl_mode='STRAND',
                                           sl_frame=1)),
    ("interlocking sl engagement",
    ...
    ("notable heptagonal dodecahedron A (genus 2)",
     lambda: bpy.ops.mesh.notable_polyhedron_add(solid='HEPTDODEC_A')),
    ("notable heptagonal dodecahedron C (genus 2)",
     lambda: bpy.ops.mesh.notable_polyhedron_add(solid='HEPTDODEC_C')),
