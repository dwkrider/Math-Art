...
OPS = [
    ...
    ("calabi-yau brieskorn trefoil",
     lambda: bpy.ops.mesh.calabi_yau_add(family='BRIESKORN', power_p=2,
                                         ...
                                         xi_steps=9,
                                         boundary_curve=True)),
    ("calabi-yau fourth-dimension colouring",
     lambda: bpy.ops.mesh.calabi_yau_add(theta_steps=7, xi_steps=7,
                                         colour='FOURTH', phase=0.3)),
    ...
    ("calabi-yau metric eguchi-hanson",
     lambda: bpy.ops.mesh.calabi_yau_metric_add(mode='EGUCHI_HANSON',
                                                steps=48, segments=32,
                                                show_bolt=True)),
    ("calabi-yau metric conifold deformed",
     lambda: bpy.ops.mesh.calabi_yau_metric_add(mode='CONIFOLD',
                                                delta=-0.25, steps=32,
                                                segments=32)),
    ("calabi-yau metric conifold node",
     lambda: bpy.ops.mesh.calabi_yau_metric_add(mode='CONIFOLD',
                                                delta=0.0, steps=32,
                                                segments=32)),
