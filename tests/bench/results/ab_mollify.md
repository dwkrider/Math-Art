# A/B: baseline vs mollify

### catenoid   time 0.18s -> 0.10s (x0.55)
| metric | baseline | mollify | verdict |
|---|---|---|---|
...
### catenoid_fine   time 0.46s -> 0.28s (x0.61)
| metric | baseline | mollify | verdict |
|---|---|---|---|
...
### seifert_span_q3   time 2.75s -> 1.14s (x0.41)
| metric | baseline | mollify | verdict |
|---|---|---|---|
...
### seifert_span_q5   time 1.70s -> 1.37s (x0.80)
| metric | baseline | mollify | verdict |
|---|---|---|---|
